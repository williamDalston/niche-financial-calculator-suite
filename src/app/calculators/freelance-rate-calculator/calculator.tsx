    ...
    <div className="rounded-xl border border-border bg-bg-surface p-6 md:p-8">
      <div className="grid gap-6 lg:gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          {/* Vacation Weeks */}
          <div>
            <label htmlFor="fr-vacation-weeks" className="mb-2 block text-sm font-medium text-text-muted">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg border border-border bg-bg-primary p-4">
            <p className="mb-3 text-sm font-medium text-text-muted">Project Rate Suggestions</p>
