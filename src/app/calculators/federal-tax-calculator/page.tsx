...
export const metadata: Metadata = {
  title: "Federal Tax Estimator 2025 | CalcEngine",
  description:
    "Estimate your 2025 federal income tax, effective tax rate, and tax bracket breakdown. Free tax calculator with standard and itemized deductions, child tax credits, and above-the-line deductions.",
  openGraph: {
    title: "Federal Tax Estimator 2025 | CalcEngine",
    description:
      "Estimate your 2025 federal income tax, effective tax rate, and tax bracket breakdown. Free tax calculator with standard and itemized deductions, child tax credits, and above-the-line deductions.",
    url: "https://calcengine.org/calculators/federal-tax-calculator",
  },
  twitter: {
...
const howItWorks = `
<p>The Federal Tax Estimator calculates your estimated U.S. federal income tax liability using the official 2025 IRS tax brackets and standard deduction amounts. Whether you are a single filer, married filing jointly, married filing separately, or head of household, this tool provides a detailed breakdown of how much you owe at each bracket level and your overall effective tax rate.</p>
...
<p>After calculating your AGI, you subtract either the standard deduction or your itemized deductions, whichever is greater. The 2025 standard deduction is $15,000 for single filers, $30,000 for married filing jointly, and $22,500 for head of household. If your itemized deductions for mortgage interest, state and local taxes (SALT, capped at $10,000), and charitable contributions exceed the standard deduction, itemizing will save you more.</p>
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "You should itemize if your total itemized deductions exceed the standard deduction for your filing status ($15,000 single, $30,000 MFJ, $22,500 HoH in 2025). Common itemized deductions include mortgage interest, state and local taxes (SALT, capped at $10,000), and charitable contributions. Since the SALT cap was introduced in 2018, fewer taxpayers benefit from itemizing. About 87% of taxpayers now use the standard deduction.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Above-the-line deductions (also called adjustments to income) reduce your Adjusted Gross Income (AGI) regardless of whether you itemize. Common above-the-line deductions include traditional IRA contributions (up to $7,000 in 2025, $8,000 if age 50+), student loan interest (up to $2,500), HSA contributions ($4,300 individual, $8,550 family in 2025), and educator expenses. These are particularly valuable because they also reduce your AGI, which can qualify you for other tax benefits.",
  },
  {
    question: "How does filing status affect my taxes?",
    answer:
      "Your filing status determines your standard deduction amount and the income thresholds for each tax bracket. Married Filing Jointly generally offers the most favorable brackets and the highest standard deduction ($30,000). Head of Household, available to unmarried taxpayers with dependents, offers better rates than Single status. Married Filing Separately uses the narrowest brackets and is rarely advantageous unless one spouse has significant medical expenses or student loan payments tied to income.",
  },
  {
    question: "Does this calculator include Social Security and Medicare taxes?",
    answer:
      "No, this calculator estimates federal income tax only. Social Security tax (6.2% on earnings up to $176,100 in 2025) and Medicare tax (1.45% on all earnings, plus 0.9% surtax on earnings over $200,000) are calculated separately. Combined, these FICA taxes add roughly 7.65% for most employees. Use our Take-Home Pay Calculator to see your total paycheck after all withholdings including FICA, federal, and state taxes.",
  },
];
...
<h2>Federal Tax Planning Strategies for 2025</h2>
...
<p>Contributing to tax-advantaged retirement accounts is one of the most powerful ways to reduce your current tax bill. Traditional 401(k) contributions (up to $23,500 in 2025, $31,000 if age 50+) are made pre-tax, directly reducing your taxable income. Traditional IRA contributions (up to $7,000, $8,000 if age 50+) may also be deductible depending on your income and whether you have an employer plan. HSA contributions offer a triple tax advantage: deductible contributions, tax-free growth, and tax-free withdrawals for qualified medical expenses.</p>
...
export default function FederalTaxCalculatorPage() {
  return (
    <CalculatorLayout
      ...
      description="Estimate your 2025 federal income tax, effective tax rate, and tax bracket breakdown with standard or itemized deductions and child tax credits."
