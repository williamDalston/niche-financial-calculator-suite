      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Free salary and career calculators for converting wages, estimating take-home pay, planning raises, setting freelance rates, comparing cost of living, and more. Make smarter compensation decisions with CalcEngine.",
            url: "https://calcengine.io/category/salary-and-career",
            numberOfItems: 9,
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Salary to Hourly Converter", url: "https://calcengine.io/calculators/salary-to-hourly" },
              { "@type": "ListItem", position: 2, name: "Hourly to Salary Converter", url: "https://calcengine.io/calculators/hourly-to-salary" },
              { "@type": "ListItem", position: 3, name: "Take-Home Pay Calculator", url: "https://calcengine.io/calculators/take-home-pay-calculator" },
              { "@type": "ListItem", position: 4, name: "Overtime Calculator", url: "https://calcengine.io/calculators/overtime-calculator" },
              { "@type": "ListItem", position: 5, name: "Raise Calculator", url: "https://calcengine.io/calculators/raise-calculator" },
              { "@type": "ListItem", position: 6, name: "Freelance Rate Calculator", url: "https://calcengine.io/calculators/freelance-rate-calculator" },
              { "@type": "ListItem", position: 7, name: "Cost of Living Calculator", url: "https://calcengine.io/calculators/cost-of-living-calculator" },
              { "@type": "ListItem", position: 8, name: "Tip Calculator", url: "https://calcengine.io/calculators/tip-calculator" },
              { "@type": "ListItem", position: 9, name: "Wage Gap Calculator", url: "https://calcengine.io/calculators/wage-gap-calculator" },
            ],
          }),
        }}
      />
